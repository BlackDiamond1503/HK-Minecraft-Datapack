execute as @e[type=!player, type=!item, type=!block_display, type=!item_display, distance=..3] at @s unless entity @s[tag=hk.spirit.damaged] run damage @s 15 player_attack by @p
